...
def build_login_page(error=""):
    ...
    form = html.Div([
        ...
        html.Div(id="login-section", children=[
            ...
            html.Div([
                html.Span("Forgot your password? ", style={"color":MUTED,"fontSize":"12px"}),
                html.A("Click here to reset",
                    href=f"{BACKEND_HTTP}/api/auth/reset-form",
                    target="_blank",
                    style={"color":TEAL_DIM,"fontSize":"12px","fontWeight":"700",
