...
def build_radar_tab(session=None):
    ...
    free_banner = html.Div(
        f"ðŸ”’ Free Plan â€” Top {radar_limit} symbols Â· {delay_min}-minute delayed data Â· Composite score only Â· No alerts. Upgrade to unlock full access.",
