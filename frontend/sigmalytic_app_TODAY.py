...
def build_billing_tab(session=None, perms=None):
    ...
    if status == "past_due":
        ...
        banner_text  = " Payment past due - please update your payment method to restore full access."
    elif cancel_end:
        banner_color = YELLOW_DIM
        banner_bg    = "rgba(245,158,11,.08)"
        banner_border= "rgba(245,158,11,.25)"
        banner_text  = f" Your plan is set to cancel on {period_end}. Reactivate anytime below."
    elif tier == "free":
    ...
    pricing_section = _card([
        ...
        html.Div([
            html.Div(" Institutional", style={"color": WHITE, "fontSize": "16px",
...
def build_preferences_tab(user_id="", session=None):
    ...
    return html.Div([
        ...
        _card([_stitle(" Weis Wave Sensitivity"),
...
LOGO = html.Div([
    html.Div("",style={"fontSize":"28px","fontWeight":"900","color":TEAL_DIM,"lineHeight":"1",
    ...
    if tab=="feed":          main = build_feed_tab(live,live_mode)
        ...
        if _CAMPAIGN_TAB_AVAILABLE:
            try:
                ...
                main = html.Div([
                    html.Div(" Campaign tab error", style={"color":"#f87171","fontWeight":"700","marginBottom":"8px"}),
