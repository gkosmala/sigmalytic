...
def build_command_tab(live, candles, symbol, tf):
    ...
    row3 = card([
        ...
        note_box("Synthetic options layer â€” connect Tradier or CBOE for live institutional flow data.","blue"),
    ], sx={"marginBottom":"16px"})
...
LOGO = html.Div([
    html.Div("Î£",style={"fontSize":"28px","fontWeight":"900","color":"#B8860B","textShadow":"0 0 4px rgba(224,178,63,.45), 0 1px 0 #6E4700","lineHeight":"1","fontFamily":"Georgia, serif","marginRight":"4px","flexShrink":"0"}),
    html.Div([
