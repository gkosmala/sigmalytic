...
# SIGMALYTIC_STEP100R_Q_DEFER_HEAVY_TODAY_TABS
try:
    app.config.suppress_callback_exceptions = True
except Exception:
    pass

_STEP100R_Q_HEAVY_TABS = {
    "command": "Command Center",
    "campaigns": "Campaigns",
    "radar": "Radar Screen",
    "scoreboard": "Scoreboard",
...
def _step100r_q_lazy_heavy_tab_shell(tab, label):
    return html.Div([
        dcc.Store(id="step100r-q-pending-tab", data=tab),
        dcc.Interval(id="step100r-q-load-trigger", interval=75, n_intervals=0, max_intervals=1),
        html.Div([
            ...
            html.Div("Loading live tab content...", style={
                "color": MUTED,
                "fontSize": "12px",
                "fontWeight": "700",
            }),
        ...
        html.Div(
            id="step100r-q-heavy-tab-content",
            children=html.Div("Preparing...", style={
                "color": MUTED,
                "fontSize": "12px",
                "padding": "14px 2px",
            }),
...
@app.callback(
    Output("step100r-q-heavy-tab-content", "children"),
    Input("step100r-q-load-trigger", "n_intervals"),
    State("step100r-q-pending-tab", "data"),
    State("s-live", "data"),
...
def _step100r_q_hydrate_heavy_tab(n_intervals, tab, live, candles, live_mode, symbol, tf):
    ...
    try:
        ...
        return html.Div(f"Unknown deferred tab: {tab}", style={
            "color": MUTED,
            "padding": "60px",
            "textAlign": "center",
        })
        ...
        return html.Div([
            html.Div(f"{_STEP100R_Q_HEAVY_TABS.get(tab, tab)} tab error", style={
                "color": "#f87171",
                "fontWeight": "800",
                "marginBottom": "8px",
            }),
...
def render_main(_status_clicks, _command_clicks, _feed_clicks, _performance_clicks,
    ...
    if tab in _STEP100R_Q_HEAVY_TABS:
        main = _step100r_q_lazy_heavy_tab_shell(tab, _STEP100R_Q_HEAVY_TABS.get(tab, tab))
